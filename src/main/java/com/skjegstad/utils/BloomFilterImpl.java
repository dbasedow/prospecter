...
public class BloomFilterImpl<E> implements Serializable, BloomFilter<E> {
     ...
     */
    public BloomFilterImpl(double c, int n, int k) {
     ...
     */
    public BloomFilterImpl(int bitSetSize, int expectedNumberOElements) {
     ...
     */
    public BloomFilterImpl(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public BloomFilterImpl(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
    ...
    public boolean equals(Object obj) {
        ...
        final BloomFilterImpl<E> other = (BloomFilterImpl<E>) obj;
